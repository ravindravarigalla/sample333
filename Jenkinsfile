pipeline {
  ...
  environment {
    IMAGE_TAG = "registry-intl.ap-southeast-5.cr.aliyuncs.com/sales/test:latest"
      ...
      steps {
        container('helm') {
          ...
          sh """
            ...
            kubectl get nodes
            kubectl create deployment test --image registry-intl.ap-southeast-5.cr.aliyuncs.com/sales/test:latest -n default
